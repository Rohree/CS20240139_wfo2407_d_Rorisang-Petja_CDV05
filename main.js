...
const roryTexture = new THREE.TextureLoader().load(heroImg);

const rory = new THREE.Mesh(new THREE.BoxGeometry(3, 3, 3), new THREE.MeshBasicMaterial({ map: roryTexture }));
...
function moveCamera() {
  ...
  rory.rotation.y += 0.01;
  rory.rotation.z += 0.01;
